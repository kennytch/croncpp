...
TEST_CASE("invalid date", "[std]")
{
   check_next("0 30 * * * *", "2022-06-31 02:40:00", "2022-07-01 03:30:00");
   check_next("0 30 * * * *", "2022-02-31 02:40:00", "2022-03-03 03:30:00");
}
...
TEST_CASE("next", "[std]")
{
   ...
   check_next("0 25 23 31 7 ?", "2011-09-22 23:25:00", "2012-07-31 23:25:00");
   check_next("0 25 23 31 8 ?", "2011-09-22 14:20:00", "2012-08-31 23:25:00");
   check_next("0 25 23 31 8 ?", "2011-09-22 23:25:00", "2012-08-31 23:25:00");
   check_next("0 25 23 31 8 ?", "2022-02-29 23:25:00", "2022-08-31 23:25:00");
   check_next("0 25 23 29 2 ?", "2010-09-22 23:25:00", "2012-02-29 23:25:00");
   check_next("0 25 23 29 2 ?", "2009-09-22 23:25:00", "2012-02-29 23:25:00");
   check_next("0 30 4 * * *", "2022-03-12 04:30:00", "2022-03-13 04:30:00");
   check_next("0 30 * * * *", "2022-03-27 00:59:00", "2022-03-27 01:30:00");
   check_next("0 30 * * * *", "2022-03-27 01:09:00", "2022-03-27 01:30:00");
   check_next("0 30 * * * *", "2022-10-30 01:59:00", "2022-10-30 02:30:00");
   check_next("0 30 * * * *", "2022-10-30 02:09:00", "2022-10-30 02:30:00");
}
